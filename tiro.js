...
function Tiro(posicao, angulo) {
  ...
  this.hits = function(meteoro){
    var d = dist(this.posicao.x, this.posicao.y, meteoro.posicao.x, meteoro.posicao.y);//calcula a distancia entre o meteoro e o tiro
    if(d < meteoro.r){ //se a distancia for menor que o raio do meteoro retorna verdadeiro, se não retorna falso
      return true;
    }else{
      return false;
    }
